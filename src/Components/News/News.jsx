  ...
  return (
    <div className=''>
      ...
      <h2 className='font-semibold text-3xl text-third'>Govt continues monitoring pharmacy sector:
        ...
        <div className='md:grid grid-cols-2 gap-10 xl:gap-44 md:px-20 px-10 '>
            <div className='col-span-1'>
            
            <img className='w-[100%] h-[70%]   py-10' src={news1} alt="" />
            </div>
            <div className='col-span-1'>
            <p className='text-textpara py-10 md:px-10'>KATHMANDU, Sept 25: Minister for Health and Population Mohan Bahadur Basnet said the government has been monitoring anomalies in the pharmacy sector and taking action as required for reforming this sector. He also urged the concerned authorities to be serious about the sensitivity of the pharmacy sector and directed for reform efforts.
